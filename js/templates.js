function getExplanationOverlay() {
  return `
    ...
    <div class="overlay-header"><h2>Explanation</h2> <button class="close-btn" onclick="closeOverlay('game-explanation')">X</button></div>
        <p>El Pollo Loco is an action-packed platform adventure set in the scorching desert. You play as Pepe, a brave explorer who can run, jump, and throw salsa bottles to defeat enemies. He can carry a maximum of five bottles and starts with 100 health points – if they drop to zero, the game is over. Collect coins and bottles along the way, avoid dangers, and use skillful jumps or precise throws to defeat chickens and eventually the final boss. You only win the game once you defeat him.
        </p>

        <h3>Controls</h3>
        <p>Pepe is easily controlled using the keyboard:</p>
        <p><b>Walk:</b> Left & Right Arrow Keys</p>
        <p><b>Jump:</b> Spacebar</p>
        <p><b>Throw salsa bottle:</b> D key</p>
...
function getImprintOverlay() {
    return `
        <div class="game-explanation">
            <div class="overlay-header"><h2>Imprint</h2> <button class="close-btn" onclick="closeOverlay('imprint')">X</button></div>
            <h3>Diensteanbieter</h3>
            <p>Marina Denker</p>
            <p>Am Schmiedekamp 4</p>
            <p>28816 Stuhr</p>

            <h2>Kontaktmöglichkeiten</h3>
